...
Donate link:       http://tannermoushey.com
...
== Description ==
This is a simple plugin used to hide XProfile Field groups from different user types based on the user's role. To hide a field group, go to Users -> Conditional Groups in the wp-admin and check appropriate box in the grid.
